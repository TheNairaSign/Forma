...
class _ChartDataContainerState extends ConsumerState<ChartDataContainer> {
  ...
  List<DailySteps> get currentData {
    debugPrint('ChartDataContainer: currentData');
    switch (stepsState.selectedRange) {
  ...
  Widget build(BuildContext context) {
    ...
    final range = ref.watch(stepsProvider.notifier).selectedRange;
